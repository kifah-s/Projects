...
{
private:
    static void PrintTransferLogRecordLine(stTransferLogRecord TransferLogRecord)
    {
...
public:
    static void ShowTransferLogScreen()
    {
        ...
        vector<stTransferLogRecord> vTransferLogRecord = clsBankClient::GetTransfersLogList();
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (stTransferLogRecord Record : vTransferLogRecord)
            {
