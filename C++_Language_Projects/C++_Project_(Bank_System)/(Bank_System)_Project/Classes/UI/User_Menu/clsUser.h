...
#include "../../Public/clsDate.h"
#include "../../Public/clsUtil.h"
...
private:
    ...
    {
        fstream MyFile;
        MyFile.open("Database/Users.txt", ios::out); // Overwrite.
    ...
    {
        fstream MyFile;
        MyFile.open("Database/Users.txt", ios::out | ios::app);
...
public:
    ...
    void RegisterLogIn()
    {
        ...
        fstream MyFile;
        MyFile.open("Database/LoginRegister.txt", ios::out | ios::app);
    ...
    static vector<stLoginRegisterRecord> GetLoginRegisterList()
    {
        ...
        fstream MyFile;
        MyFile.open("Database/LoginRegister.txt", ios::in); // Read Mode
